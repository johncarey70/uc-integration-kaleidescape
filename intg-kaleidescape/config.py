...
This module supports Kaleidescape Player integration in UC API-based environments.
"""
...
import ucapi
from player import KaleidescapeInfo as Info
...
class Devices:
    ...
    def load(self) -> bool:
        ...
        try:
            ...
            for item in data:
                if not all(k in item for k in ("id", "host")):
